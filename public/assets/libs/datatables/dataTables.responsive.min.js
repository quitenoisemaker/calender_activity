...
(function(d) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(l) { return d(l, window, document) }) : "object" === typeof exports ? module.exports = function(l, j) { l || (l = window); if (!j || !j.fn.dataTable) j = require("datatables.net")(l, j).$; return d(j, l, l.document) } : d(jQuery, window, document) })(function(d, l, j, q) {
    ...
    d.extend(i.prototype, {
        ...
        _columnsVisiblity: function(a) {
            ...
            var s = !1;
            e = 0;
            for (f = g.length; e < f; e++) { var k = g[e].columnIdx; "-" === h[k] && (!c[k].control && c[k].minWidth) && (s || 0 > m - c[k].minWidth ? (s = !0, h[k] = !1) : h[k] = !0, m -= c[k].minWidth) } g = !1;
            e = 0;
            for (f = c.length; e < f; e++)
                if (!c[e].control &&
                    !c[e].never && !1 === h[e]) { g = !0; break } e = 0;
        ...
        _classLogic: function() {
            ...
            e.each(function(a, e) {
                for (var c = a.className.split(" "), f = !1, i = 0, l = c.length; i < l; i++) {
                    ...
                    if ("control" === j) { f = !0;
                        a.control = !0; return } d.each(b, function(a, b) { var d = b.name.split("-"),
        ...
        _detailsInit: function() {
            ...
            d(b.table().body()).on("click.dtr mousedown.dtr mouseup.dtr",
                ...
                function(c) { if (d(b.table().node()).hasClass("collapsed") && d.inArray(d(this).closest("tr").get(0), b.rows().nodes().toArray()) !== -1) { if (typeof e === "number") { var g = e < 0 ? b.columns().eq(0).length + e : e; if (b.cell(this).index().column !== g) return } g = b.row(d(this).closest("tr"));
        ...
        _resize: function() {
            ...
            for (h = e.length - 1; 0 <= h; h--)
                if (c <= e[h].width) { f = e[h].name; break } var i = this._columnsVisiblity(f);
            this.s.current = i;
            e = !1;
            h = 0;
            for (c = g.length; h < c; h++)
                if (!1 === i[h] && !g[h].never && !g[h].control && !1 === !b.column(h).visible()) { e = !0; break } d(b.table().node()).toggleClass("collapsed", e);
            var k = !1,
                j = 0;
        ...
        _resizeAuto: function() {
            ...
            if (this.c.auto && -1 !== d.inArray(!0, d.map(b, function(a) { return a.auto }))) {
                ...
                if (f = a.table().footer()) { var f = d(f.cloneNode(!1)).appendTo(c),
                    ...
                    d("<tr/>").append(h).appendTo(f) } d("<tr/>").append(g).appendTo(e);
