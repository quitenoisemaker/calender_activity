...
(function(f) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(k) { return f(k, window, document) }) : "object" === typeof exports ? module.exports = function(k, h) { k || (k = window); if (!h || !h.fn.dataTable) h = require("datatables.net")(k, h).$; return f(h, k, k.document) } : f(jQuery, window, document) })(function(f, k, h, o) {
    ...
    f.extend(n.prototype, {
        ...
        _constructor: function() {
            ...
            if (this.c.editor) {
                ...
                if (this.c.editOnFocus) b.on("key-focus.keyTable key-refocus.keyTable", function(b, c, d, e) { a._editor(null, e, !0) });
                b.on("key.keyTable", function(b, c, d, e, f) { a._editor(d, f, !1) });
        ...
        _clipboard: function() {
            var a = this.s.dt,
                b = this;
            k.getSelection && (f(h).on("copy.keyTable", function(a) { var a = a.originalEvent,
                    d = k.getSelection().toString(),
                    e = b.s.lastFocus;!d && e && (a.clipboardData.setData("text/plain", e.cell.render(b.c.clipboardOrthogonal)), a.preventDefault()) }), f(h).on("paste.keyTable", function(c) {
            ...
            if (!f("div.DTE", g.node()).length && !(null !== a && (0 <= a && 9 >= a || 11 === a || 12 === a || 14 <= a && 31 >= a || 112 <= a && 123 >= a || 127 <= a && 159 >= a))) {
                ...
                var i = function() {
                    j.one("open.keyTable", function() {
                        ...
                        e.on("key-blur.editor", function() { j.displayed() && j.submit() });
                        c && f(e.table().container()).addClass("dtk-focus-alt");
                        j.on("submitUnsuccessful.keyTable", function() { d._focus(g, null, !1) });
                        j.one("close", function() { e.keys.enable(!0);
        ...
        _focus: function(a, b, c, d) {
            ...
            d || (d = null);
            if (this.s.enable) {
                if ("number" !== typeof a) { if (!a.any()) return; var m = a.index(),
                        b = m.column,
                        a = j.rows({ filter: "applied", order: "applied" }).indexes().indexOf(m.row); if (0 > a) return;
                    g.serverSide && (a += g.start) }
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, j.one("draw", function() { e.s.focusDraw = !1;
                    e.s.waitingForDraw = !1;
                    e._focus(a, b, o, d) }).page(Math.floor(a / g.length)).draw(!1);
                else if (-1 !== f.inArray(b, this._columns())) {
                    g.serverSide &&
                        (a -= g.start);
                    g = j.cells(null, b, { search: "applied", order: "applied" }).flatten();
                    g = j.cell(g[a]);
                    if (i) { if (i.node === g.node()) { this._emitEvent("key-refocus", [this.s.dt, g, d || null]); return } this._blur() } i = f(g.node());
        ...
        _scroll: function(a, b, c, d) { var e = c[d](),
                f = c.outerHeight(),
                g = c.outerWidth(),
                i = b.scrollTop(),
                m = b.scrollLeft(),
                h = a.height(),
                a = a.width(); "position" === d && (e.top += parseInt(c.closest("table").css("top"), 10));
        ...
        _shift: function(a, b, c) {
            var d = this.s.dt,
                ...
                g = this.s.lastFocus.cell,
                i = this._columns();
            if (g) { var h = d.rows({ filter: "applied", order: "applied" }).indexes().indexOf(g.index().row);
                e.serverSide && (h += e.start);
                d = d.columns(i).indexes().indexOf(g.index().column);
                e = i[d]; "right" === b ? d >= i.length - 1 ? (h++, e = i[0]) : e = i[d + 1] : "left" === b ? 0 === d ? (h--, e = i[i.length - 1]) : e = i[d - 1] : "up" === b ? h-- : "down" === b && h++;
    ...
    n.defaults = { blurable: !0, className: "focus", clipboard: !0, clipboardOrthogonal: "display", columns: "", editor: null, editOnFocus: !1, focus: null, keys: null, tabIndex: null };
    n.version = "2.5.0";
    ...
    l.ext.selector.cell.push(function(a, b, c) { var b = b.focused,
            a = a.keytable,
            d = []; if (!a || b === o) return c; for (var e = 0, f = c.length; e < f; e++)(!0 === b && a.focused(c[e]) || !1 === b && !a.focused(c[e])) && d.push(c[e]); return d });
    f(h).on("preInit.dt.dtk", function(a, b) {
        if ("dt" ===
            a.namespace) { var c = b.oInit.keys,
